<div class="product-inner-section">
 ...
 <form action="<?= base_url()?>filterproducts" method="get" id="filterform" enctype="multipart/form-data">
  ...
  <input type="hidden" name="ref2" id="subsubcat_id" value="<?= $subsubcat_id ?>"/>  
    ...
    <?php if($this->uri->segment(1)== "allprdoucts"){ ?>
...
$(function() {
    var minvalue=parseInt("<?= (isset($_GET['min-price']) && $_GET['min-price'] > 0)? $_GET['min-price']  : $min_range ?>");
    var maxvalue=parseInt("<?= (isset($_GET['max-price']) && $_GET['max-price'] > 0)? $_GET['max-price']  : $max_range ?>");
