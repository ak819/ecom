...
<?php if($flag == "processtologin")  { ?>
  ...
  <?php  } ?>
  <?php if($flag == "signup" or $flag == "do_signup")  { ?>
   <style>
            #login-toggle{
...
<body>
   <div class="main" style="text-align: center; margin-top: 35px; font-size: 35px;font-weight: bold; color: #ff8d00">
    <div class="content-1">
...
<div class="form-modal">
    ...
    <div id="login-form">
      ...
      <h6 style="color:red;text-align:center;"><?php if($this->session->flashdata('login_status')){ echo $this->session->flashdata('login_status');  }  ?></h6>
        <form action="<?= base_url()?>processtologin" method="post" id="login">
            ...
            <!--  <p>Clicking <strong>create account</strong> means that you are agree to our <a href="javascript:void(0)">terms of services</a>.</p>
             <p style="color: #ff8d00; font-size: 12px;"><a href="#"><i class="fa fa-chevron-circle-right" aria-hidden="true"> need help ? </i></a></p> -->
       
        </form>
    </div>

    <div id="signup-form">
        <form action="<?= base_url()?>signup" method="post" id="registration"> 
