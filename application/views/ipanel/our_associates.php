...
<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Our associates management</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                       <div id="add_cat" <?= ($flag=='edit')?"style='display:block'":"style='display:none'"?> >
                        <div class="card">
                           <form class="form-horizontal" action="<?= base_url();?>ipanel/associates/<?= ($flag=="edit")?"update/".$this->uri->segment(4):"store" ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                          
                                <div class="card-body">
                                    <h4 class="card-title">Our associates Details</h4>
             ...
             <div class="col-md-2">
                 ...
                 <div class="card">
                            <div class="card-body">
   <h5 class="card-title">Our associates list</h5>
                                           ...
                                           <tr>
                                            ...
                                            <tbody id="new_tbody">
                                              ...
                                              foreach ($companylist_list as $key => $value) {
                                                ...
                                                <td>
                                                  <?php if($value->image){ ?>
                                                  <a href="<?php echo base_url();?>assets/ipanel/uploads/associates_img/<?php echo $value->image;?>"
                                                    >
                                                  <img style="width:150;height:150px;" src="<?php echo base_url();?>assets/ipanel/uploads/associates_img/<?php echo $value->image;?>" />
                                                <?php }else{ ?>
                                              ...
                                              <td> <a href="<?= base_url();?>ipanel/associates/edit/<?= $value->id?>" class="btn btn-cyan btn-sm" data-original-title="Edit">Edit</a>
                                                  
                                             <?php if ($value->status=="a"){ ?>
                            <a class="btn btn-success btn-xs"  href="<?= base_url();?>ipanel/associates/status/d/<?=$value->id;?>"> <?= "Active" ?> </a>
                          <?php }else{ ?>
                            <a class="btn btn-danger btn-xs" href="<?= base_url();?>ipanel/associates/status/a/<?=$value->id;?>"> <?= "Deactive" ?> </a>
                           <?php   } ?> 
...
function close_unit()
{
  ...
  $('.button_class').css('display','block');
   var url="<?= base_url()?>ipanel/associates";
