        ...
        <div class="page-wrapper form-1">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="page-title">Product Video Management</h3>
          ...
          <div class="col-12">
            ...
            <button type="button" style="margin-bottom: 31px;"  data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-primary btn-sm">Add New Video </button>
                <div class="card">
                        ...
                        foreach ($p_images as $key => $value) {
                          ...
                          <td>
                           ...
                           <!--  <a href="<?= base_url();?>ipanel/product/editImage/<?= $value->p_id ?>/<?= $value->id?>" class="btn btn-primary btn-sm">Edit</a> -->
                            ...
                            <a onclick="return confirm('Are you sure to Delete this record?')" href="<?= base_url();?>ipanel/product/deletevideo/<?= $value->name ?>/<?= $value->id ?>" class="btn btn-danger btn-sm">Delete</a>

                               <?php if ($value->status =='a'){ ?>
                          <a href="<?= base_url();?>ipanel/product/videostatus/d/<?= $value->p_id;?>/<?= $value->id;?>" class="btn btn-success btn-sm" data-original-title="Click to Deactivate">Activated</a>
                        <?php } else { ?> <a href="<?= base_url();?>ipanel/product/videostatus/a/<?= $value->p_id;?>/<?= $value->id;?>" class="btn btn-danger btn-sm" data-original-title="Click to Activate">Deactivated</a> <?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url();?>ipanel/product/storevideo/" class="dropzone" id="dropzonewidget" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        <a href="<?= base_url()?>ipanel/product/video/<?= $this->uri->segment(4); ?>" class="btn btn-secondary" >Close</a>
...
<script type="text/javascript">
  ...
  if (answer){
          ...
          $.ajax({
           ...
           type: 'POST',
           url: '<?= base_url();?>ipanel/product/removevideo/',
